function result = vsg_signal_snapshot(model_name, time_s, signals, allow_partial)
%VSG_SIGNAL_SNAPSHOT  Read logged/to-workspace/block-output values at a target time.
