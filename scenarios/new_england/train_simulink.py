...
def parse_args():
    ...
    parser.add_argument("--checkpoint-dir", default=None,
                        help="Checkpoint directory (default: results/sim_ne39/checkpoints/<mode>/)")
    ...
    parser.add_argument("--log-file", default=None,
                        help="Training log JSON path (default: results/sim_ne39/logs/<mode>/training_log.json)")
...
def train(args):
    ...
    for ep in range(start_episode, end_episode):
        ...
        if (ep + 1) % args.eval_interval == 0:
            ...
            log["eval_rewards"].append({"episode": ep + 1, "reward": float(eval_reward)})
