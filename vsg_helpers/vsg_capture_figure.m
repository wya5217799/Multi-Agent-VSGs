function result = vsg_capture_figure(out_path, figure_id, capture_all, resolution)
%VSG_CAPTURE_FIGURE Capture MATLAB figure window(s) as PNG.
%
%   result = vsg_capture_figure(out_path, figure_id, capture_all, resolution)
%
