function summary = vsg_add_block(source_block, destination_block, params, make_name_unique)
%VSG_ADD_BLOCK Add a block from a library and optionally set dialog params.
