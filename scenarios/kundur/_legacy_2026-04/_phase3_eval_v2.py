...
Output: results/andes_phase3_eval_v2/{ddic_seedXX, nocontrol, adaptive}.json + summary.json
"""
...
OUT_DIR = "results/andes_phase3_eval_v2"
...
def factory_ddic(seed: int, ckpt_kind: str = "best"):
    ...
    ckpt_dir = f"results/andes_phase3_seed{seed}"
    N = AndesMultiVSGEnv.N_AGENTS
