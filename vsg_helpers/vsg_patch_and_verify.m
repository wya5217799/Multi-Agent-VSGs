function result = vsg_patch_and_verify(model_name, edits, run_update, smoke_test_stop_time, timeout_sec)
%VSG_PATCH_AND_VERIFY Apply edits, read them back, and optionally run update/smoke test.
